<template>
    <div :class="rootClass" :data-key="key">
        ...
        <div :class="wrapperClass" @click="checked = !checked">
            ...
            <slot name="enabled" v-show="checked"></slot>
            <slot name="disabled" v-show="!checked"></slot>
        </div>
    </div>
</template>
<script>
                ...
                default() {
                    return {
                        ...
                        checkbox: {
                            ...
                            toggle: {
                                'bg-white w-0 h-0 rounded-sm shadow-md bg-blue-300 mx-auto': true,
                                'transform': true,
                                'duration-300 ease-in-out': true,
                            },
                            active_wrapper: {
                        ...
                        radio: {
                            ...
                            toggle: {
                                'bg-white w-0 h-0 shadow-md bg-blue-300 rounded-full mx-auto': true,
                                'transform': true,
                                'duration-300 ease-in-out': true,
                            },
                            active_wrapper: {
